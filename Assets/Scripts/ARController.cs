...
namespace GoogleARCore.HelloAR
{
    ...
    public class ARController : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            //{
                ...
                if (Session.Raycast(m_firstPersonCamera.ScreenPointToRay(touch.position), raycastFilter, out hit))
                {
                    ...
                    var andyObject = Instantiate(SelectedObject, hit.Point, Quaternion.identity,
                        anchor.transform);
                DeleteButtonMethod();
                ArFunctions.Instance.PutInList(andyObject as GameObject);
        ...
        public void BeverageActivate()
        {
            // 0 is Beverage Station
            SelectedObject = Objects_to_Activate[0].gameObject;
        }

        public void DesertActivate()
        {
            // 1 is Desert Station
            SelectedObject = Objects_to_Activate[1].gameObject;
        }

        public void SandwichActivate()
        {
            // 2 is Sandwich Station
            SelectedObject = Objects_to_Activate[2].gameObject;
        }

        public void FryActivate()
        {
            // 3 is Fry Station
            SelectedObject = Objects_to_Activate[3].gameObject;
        }
        ...
        void CheckForCollision(Ray ray)
        {
            // cast a ray from the camera to the world position and check for object collision
