...
namespace GoogleARCore.HelloAR
{
    ...
    /// </summary>
    public class TireTapsController : MonoBehaviour
    {
        /// <summary>
        ...
        private bool castleActive = false;
        ...
        public void Start()
        {
            SelectedObject = Objects_to_Activate[0];
        }
        public void Update()
        {
        ...
        public void CheckForCollision()
        {
            ...
            if (Physics.Raycast(raycast, out raycastHit))
            {
                ...
                {
                    Destroy(raycastHit.rigidbody.gameObject);
                }
